...
- **💳 TukShopp Wallet** - Digital wallet for instant payments, auto top-up, and faster checkout
- **📦 Pickup & Delivery Requests** - Send packages anywhere without ordering from vendors

### 🚀 Coming Soon (Q4 2025)

Exciting new features in development:

- **🔍 Improved Search/Explore/Feed** - AI-powered personalized recommendations and smart discovery
- **💰 Vendor Discounts** - Time-based promotions, flash sales, and special offers
- **📢 Vendor Ads Platform** - Self-service advertising for increased visibility
- **🚴 Dedicated Rider Service** - Book your favorite riders for regular deliveries
- **📦 Enhanced Pickup/Delivery** - Package insurance, business accounts, and bulk delivery options
...
### 💻 For Developers (Public API Documentation)
...
### 🔧 For Engineering Team (Internal Documentation)

#### [Technical Specifications](./technical-specs/) 🏗️
...
*Everything you need, delivered when you need it.* 🛍️
